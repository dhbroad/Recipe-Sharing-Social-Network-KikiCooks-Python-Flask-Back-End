...
def home():
    return redirect(url_for('/api/posts')) # changed our homepage to be ig.posts.html instead of index.html. url_for() returns the url or 'route' of the function you pass in. posts() is a funciton in our ig routes that has the route /posts
